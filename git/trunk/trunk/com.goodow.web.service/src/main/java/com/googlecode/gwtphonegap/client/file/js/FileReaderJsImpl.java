...
public final class FileReaderJsImpl extends JavaScriptObject implements FileReader {
  ...
  private static void onCallback(final ReaderCallback<FileReader> callback,
      final FileReaderJsImpl reader) {
  ...
  @Override
  public void readAsDataUrl(final FileEntry entry) {
  ...
  @Override
  public void readAsText(final FileEntry entry) {
    FileEntryJsImpl entryJs = (FileEntryJsImpl) entry;
