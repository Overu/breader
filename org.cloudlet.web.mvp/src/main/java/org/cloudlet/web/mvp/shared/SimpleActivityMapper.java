...
public final class SimpleActivityMapper implements ActivityMapper, HasName {
  ...
  private final Map<String, Provider<Activity>> placeToActivity =
      new HashMap<String, Provider<Activity>>();
  ...
  public <T extends Place> void addBinding(Class<T> place,
      Provider<? extends Activity> activityProvider) {
