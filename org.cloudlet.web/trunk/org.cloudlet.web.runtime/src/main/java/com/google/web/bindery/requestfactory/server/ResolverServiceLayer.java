...
//
// private static synchronized void updateDeobfuscator(final Class<? extends RequestFactory> clazz,
// final ClassLoader resolveClassesWith) {
...
//
// @Override
// public Class<? extends BaseProxy> resolveClass(final String typeToken) {
...
// final Class<T> clientClass, final boolean required) {
...
//
// @Override
// public Class<?> resolveDomainClass(final Class<?> clazz) {
...
//
// @Override
// public Method resolveDomainMethod(final String operation) {
// /*
// * The validator has already determined the mapping from the RequsetContext method to a domain
// * method signature. We'll reuse this calculation instead of iterating over all methods.
// */
...
//
// /* our change begin */
// if (InstanceRequest.class.isAssignableFrom(requestContextMethod.getReturnType())) {
// Class<?> clientType =
// TypeUtils.ensureBaseType(getTop().getRequestReturnType(requestContextMethod));
// try {
// return getTop().resolveDomainClass(clientType).getMethod(requestContextMethod.getName(),
// domainArgs);
// } catch (SecurityException e) {
// } catch (NoSuchMethodException e) {
// } catch (Exception e) {
// Logger.getLogger(getClass().getName()).log(Level.SEVERE, "UnexpectedException", e);
// }
// }
// /* our change end */
//
...
//
// @Override
// public Class<? extends RequestContext> resolveRequestContext(final String operation) {
...
//
// @Override
// public Method resolveRequestContextMethod(final String operation) {
...
//
// @Override
// public Class<? extends RequestFactory> resolveRequestFactory(final String binaryName) {
...
//
// @Override
// public Class<?> resolveServiceClass(final Class<? extends RequestContext> requestContextClass) {
// Class<?> searchIn = null;
...
//
// @Override
// public String resolveTypeToken(final Class<? extends BaseProxy> clazz) {
// return OperationKey.hash(clazz.getName());
// }
//
// /**
// * Call {@link Class#forName(String)} and report any errors through {@link #die()}.
// */
...
// }
//
// private Class<?>[] getArgumentTypes(final String descriptor) {
