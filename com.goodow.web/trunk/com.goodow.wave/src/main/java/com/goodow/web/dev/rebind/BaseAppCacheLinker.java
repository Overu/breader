 ...
 * To use:
 * <ol>
 * <li>Add {@code manifest="YOURMODULENAME/appcache.nocache.manifest"} to the {@code <html>} tag in
 * your base html file. E.g., {@code <html manifest="mymodule/appcache.nocache.manifest">}</li>
 ...
 * </ol>
 * <p>
 * On every compile, this linker will regenerate the appcache.nocache.manifest file with files from
 * the public path of your module.
 * <p>
 * To obtain a manifest that contains other files in addition to those generated by this linker,
 * create a class that inherits from this one and overrides {@code otherCachedFiles()}, and use it
 * as a linker instead:
 * <p>
 * 
 * <pre><blockquote>
...
public class BaseAppCacheLinker extends AbstractLinker {
  ...
  public ArtifactSet link(final TreeLogger logger, final LinkerContext context,
      ArtifactSet artifacts, final boolean onePermutation) throws UnableToCompleteException {
  ...
  /**
   * Override this method to force the linker to also include more files in the manifest.
   */
  protected String[] otherCachedFiles() {
    return null;
  }
   ...
   */
  private Artifact<?> emitLandingPageCacheManifest(final LinkerContext context,
      final TreeLogger logger, final ArtifactSet artifacts) throws UnableToCompleteException {
  ...
  /**
   * Obtains the extra files to include in the manifest. Ensures the returned array is not null.
   */
  private String[] getCacheExtraFiles() {
    String[] cacheExtraFiles = otherCachedFiles();
    return cacheExtraFiles == null ? new String[0] : Arrays.copyOf(cacheExtraFiles,
