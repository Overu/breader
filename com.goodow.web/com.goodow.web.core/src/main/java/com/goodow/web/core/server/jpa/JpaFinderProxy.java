...
class JpaFinderProxy implements MethodInterceptor {
  ...
  private static class FinderDescriptor {
    ...
    Query createQuery(final EntityManager em) {
  ...
  private final Map<Method, FinderDescriptor> finderCache =
      new HashMap<Method, JpaFinderProxy.FinderDescriptor>();

  private final Provider<EntityManager> emProvider;

  @Inject
  public JpaFinderProxy(final Provider<EntityManager> emProvider) {
