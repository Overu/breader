...
public class BookTest extends ExampleTest {
	...
	public void testEPubBook() {
		InputStream in = BookTest.class
				.getResourceAsStream("/test-data/book1.epub");
		Resource resource = ServletMessage.createResource(in, "book1.epub",
	...
	public void testGetResource() {
		Resource result = resService
				.getById("fe924b75-44d2-4467-995d-961424f152be");
	...
	public void testSelectedBooks() {
		InputStream in = BookTest.class
				.getResourceAsStream("/test-data/book1.epub");
		Resource resource = ServletMessage.createResource(in, "book2.epub",
				"application/epub+zip");
		Book book = bookService.extract(resource);
