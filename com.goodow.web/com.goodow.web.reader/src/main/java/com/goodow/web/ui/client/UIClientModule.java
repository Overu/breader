...
import com.goodow.web.ui.client.css.AppBundle;
import com.goodow.web.ui.client.places.MyPlace;
import com.goodow.web.ui.client.places.PageMapper;
...
public class UIClientModule extends AbstractGinModule {
  ...
  private static final Logger logger = Logger.getLogger(UIClientModule.class.getName());
